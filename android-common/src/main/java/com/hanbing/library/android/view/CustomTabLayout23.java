 ...
 */
public class CustomTabLayout23 extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link CustomTabLayout23} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link CustomTabLayout23}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public CustomTabLayout23(Context context) {
        this(context, null);
    }

    public CustomTabLayout23(Context context, AttributeSet attrs) {
    ...
    public CustomTabLayout23(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorColor(a.getColor(com.hanbing.library.android.R.styleable.TabLayout_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabPaddingStart,
                mTabPaddingStart);
        ...
        mTabPaddingEnd = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabPaddingBottom,
                mTabPaddingBottom);
        ...
        try {
            mTabTextSize = ta.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TextAppearance_android_textSize, 0);
            mTabTextColors = ta.getColorStateList(com.hanbing.library.android.R.styleable.TextAppearance_android_textColor);
        } finally {
            ta.recycle();
        }
        ...
        if (a.hasValue(com.hanbing.library.android.R.styleable.TabLayout_tabSelectedTextColor)) {
            ...
            final int selected = a.getColor(com.hanbing.library.android.R.styleable.TabLayout_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(com.hanbing.library.android.R.styleable.TabLayout_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(com.hanbing.library.android.R.styleable.TabLayout_tabContentStart, 0);
    ...
    /**
     * Returns the current mode used by this {@link CustomTabLayout23}.
     *
     * @see #setTabMode(int)
     */
    @Mode
...
//                });
    ...
    public static final class Tab {
        ...
        private final CustomTabLayout23 mParent;

        Tab(CustomTabLayout23 parent) {
            mParent = parent;
        }
...
//                setBackgroundDrawable(TintManager.getDrawable(context, mTabBackgroundResId));
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(com.hanbing.library.android.R.layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(com.hanbing.library.android.R.layout.design_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int getIndicatorLeft(View child) {
            return CustomTabLayout23.this.getIndicatorLeft(child, indexOfChild(child));
        }

        private int getIndicatorRight(View child) {
            return CustomTabLayout23.this.getIndicatorRight(child, indexOfChild(child));
        }
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                    ...
                    left = (int) (mSelectionOffset * getIndicatorLeft(nextTitle)/*nextTitle.getLeft()*/ +
                            (1.0f - mSelectionOffset) * left);
                    right = (int) (mSelectionOffset * getIndicatorRight(nextTitle)/*nextTitle.getRight()*/ +
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                onDrawIndicator(canvas, mSelectedIndicatorPaint, this, new Rect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
     ...
     * necessary calls back to the provided {@link CustomTabLayout23} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CustomTabLayout23> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(CustomTabLayout23 tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final CustomTabLayout23 tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link CustomTabLayout23.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements CustomTabLayout23.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(CustomTabLayout23.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(CustomTabLayout23.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(CustomTabLayout23.Tab tab) {
            // No-op
        }
    }
