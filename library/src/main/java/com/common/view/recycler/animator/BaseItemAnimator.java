...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    protected abstract void preAnimateRemove(RecyclerView.ViewHolder holder);
    protected abstract void actAnimateRemove(RecyclerView.ViewHolder holder, ViewPropertyAnimatorCompat animation);
    protected abstract  void afterAnimateRemove(RecyclerView.ViewHolder holder);
    ...
    protected abstract void actAnimateAdd(RecyclerView.ViewHolder holder, ViewPropertyAnimatorCompat animation);
    protected abstract void afterAnimateAdd(RecyclerView.ViewHolder holder);
