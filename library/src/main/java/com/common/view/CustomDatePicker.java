...
import com.common.view.NumberPicker.Formatter;
import com.common.view.NumberPicker.OnValueChangeListener;
...
public class CustomDatePicker extends LinearLayout implements
	...
	private void init() {
		...
		mYearPicker.setFormatter(new Formatter() {
		...
		mDayPicker.setFormatter(new Formatter() {
