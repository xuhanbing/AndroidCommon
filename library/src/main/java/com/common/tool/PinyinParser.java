...
//        return getPinyinFirstCharUpperCase(chs, false);
    }
     ...
     * @return
     */
    public String getFirstChars(String chs) {
        return getPinyinFirstCharUpperCase(chs, true);
    }
     ...
     *
     * @param chs
     * @param onlyFirstChar 只返回首字母
     * @return
     */
    public String getPinyinFirstCharUpperCase(String chs, boolean onlyFirstChar) {
        String key, value;
        buffer = new StringBuilder();
        StringBuffer firstChar = new StringBuffer();

        boolean isLastHanzi = true;
            ...
            if (key.getBytes().length >= 2) {
                ...
                if (value == null) {
                    ...
                    if (value.length() > 0) {
                        ...
                        value = s.toUpperCase() + value.substring(1);
                        firstChar.append(s.toUpperCase());
                    }
                }
            } else {
        ...
        return onlyFirstChar ? firstChar.toString() : buffer.toString();
    }
