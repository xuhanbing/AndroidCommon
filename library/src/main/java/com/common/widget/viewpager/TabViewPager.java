...
import com.common.widget.tab.TabStripWidget;
import com.common.widget.tab.TabWidget;
import com.common.widget.tab.TabWidget.OnTabClickListener;
...
public class TabViewPager extends LinearLayout implements ViewPager.OnPageChangeListener {
	...
	public void onPageScrolled(int arg0, float arg1, int arg2) {
		...
		if (mTabWidget instanceof TabStripWidget)
			((TabStripWidget)mTabWidget).scrollStripFollowViewPager(arg0, arg1, arg2);
	}
