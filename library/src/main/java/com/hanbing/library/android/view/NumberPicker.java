...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mTextColor = attributesArray.getColor(
				R.styleable.NumberPicker_textColor, Color.BLACK);
		...
		Drawable divider = attributesArray
				.getDrawable(R.styleable.NumberPicker_selectionDivider);
		mSelectionDivider = null != divider ? divider : new ColorDrawable(
				Color.BLACK);
		...
		mMinHeight = attributesArray.getDimensionPixelSize(
				R.styleable.NumberPicker_internalMinHeight, 180);

		mMaxHeight = attributesArray.getDimensionPixelSize(
				R.styleable.NumberPicker_internalMaxHeight, 180);
		...
		mMinWidth = attributesArray.getDimensionPixelSize(
				R.styleable.NumberPicker_internalMinWidth, 68);
