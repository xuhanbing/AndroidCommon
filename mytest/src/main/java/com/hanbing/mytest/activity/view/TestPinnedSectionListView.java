...
//		listView.setPadding(100, 100, 100, 100);
...
//        text.setMinHeight(300);
        text.setBackgroundColor(0x44ff0000);
    ...
    class MyAdapter extends BaseAdapter implements PinnedSectionWrapper.Adapter {
        ...
        public int nextPinnedSectionPosition(int position) {
            int current = currentPinnedSectionPosition(position);
            return current + 5 == getCount() ? current : current + 5;
        }
