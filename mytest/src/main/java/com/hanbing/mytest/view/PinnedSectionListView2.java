...
import com.hanbing.mytest.BuildConfig;
 ...
 */
public class PinnedSectionListView2 extends ListView {
    ...
    public PinnedSectionListView2(Context context) {
        super(context);
        initView();
    }
    
    public PinnedSectionListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinnedSectionListView2(Context context, AttributeSet attrs, int defStyle) {
	...
	void createPinnedShadow(int position) {
		...
		View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionListView2.this);
